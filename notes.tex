...
\begin{document}
	...
	\section{Estruturas de Dados}
		\subsection{Heap Binário}
			...
			\lstinputlisting{algoritmos/structs/heap.cpp}
	...
	\section{Ordenação}
		\subsection{Merge Sort}
			\lstinputlisting{algoritmos/sorting/mergesort.cpp}
		\subsection{Quicksort}
			\lstinputlisting{algoritmos/sorting/quicksort.cpp}
	...
	\section{Matemática}
		...
		\subsection{Sieve de Números Primos}
			\lstinputlisting{algoritmos/math/sieve.cpp}
	...
	\section{Grafos}
		...
		\subsection{Caminho mínimo}
			\subsubsection{Floyd-Warshall}
				Tempo: \( \Theta(n^3)\)
				\lstinputlisting{algoritmos/graph/floyd-warshall.cpp}
			\subsubsection{Dijkstra}
				Tempo: \( O(|V|^2) \)
				\lstinputlisting{algoritmos/graph/dijkstra.cpp}
			\subsubsection{Dijkstra com Heap}
				Tempo: \( O((|E| + |V|) \log |V|) \)
				\lstinputlisting{algoritmos/graph/dijkstra-heap.cpp}
		...
		\subsection{Ponto de Articulação}
			Para grafos não-dirigidos.
			\lstinputlisting{algoritmos/graph/pontoart.cpp}
